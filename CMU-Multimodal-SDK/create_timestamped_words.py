...
text_word = "/home/slasher/Downloads/dataset/V2/text_embedding1/"

def TimestampedWord_data(compseq, Alined_items):
    ...
    for vid_key in Alined_items:
        ...
        with open(os.path.join(text_Aligned, f'{vid_key}'), 'r') as file:
            ...
            print(compseq[title]["intervals"][0].shape)

        with open(os.path.join(text_word, file_txt), 'r') as file:
            ...
            print(compseq[title]["features"][0].shape)
...
if __name__=="__main__":
    ...
    TimestampedWord_data(compseq_TimeWord_data,text_alined)
    compseq_TimestampedWords=mmdatasdk.computational_sequence("TimestampedWords")
    compseq_TimestampedWords.setData(compseq_TimeWord_data,"TimestampedWords")
