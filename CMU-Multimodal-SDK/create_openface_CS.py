...
def OpenFace_data(compseq, Alined_items):
    ...
    for vid_key in Alined_items:
        ...
        title = title[:-4]
        compseq[title]={} 
        with open(os.path.join("/home/slasher/Downloads/dataset/V2/openface/", f'{vid_key}'), 'r') as file:
            ...
            print(compseq[title]["intervals"].shape)
...
if __name__=="__main__":
    ...
    compseq_OpenFace.deploy("MMAD_OpenFace30.csd")